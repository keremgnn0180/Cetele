...
import { Plus, Trash2, Sprout, Search, Leaf, ChevronDown } from "lucide-react";
...
function Urunler() {
  ...
  const filteredUrunler = urunler.filter((urun) => {
    const matchesSearch = urun.isim
      .toLowerCase()
      .includes(searchTerm.toLowerCase());
    const matchesCategory = filterCategory
      ? urun.kategori === filterCategory
      : true;
  ...
  return (
    <div>
      ...
      >
        <div
          style={{ display: "flex", gap: "16px", flex: 1, minWidth: "300px" }}
        >
      ...
      {filteredUrunler.length === 0 ? (
        <div className="card empty-state">
          ...
          <p style={{ marginTop: "8px" }}>
            Ekim ve hasat yapabilmek için sağ üstteki butondan ürün ekleyin.
          </p>
        </div>
      ) : (
        <div
            ...
            >
              ...
              {(urun.tohum_markasi || urun.tohum_cesidi || urun.tohum_notu) && (
                ...
                >
                  {urun.tohum_markasi && (
                    <div>
                      <strong>Marka:</strong> {urun.tohum_markasi}
                    </div>
                  )}
                  {urun.tohum_cesidi && (
                    <div>
                      <strong>Çeşit:</strong> {urun.tohum_cesidi}
                    </div>
                  )}
                  {urun.tohum_notu && (
                    <div>
                      <strong>Not:</strong> {urun.tohum_notu}
                    </div>
                  )}
                </div>
              )}
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                ...
                <select
                  ...
                  value={form.kategori}
                  onChange={(e) =>
                    setForm({ ...form, kategori: e.target.value, isim: "" })
                  }
                >
                  {Object.keys(PREDEFINED_PRODUCTS).map((kat) => (
                    <option key={kat} value={kat}>
              ...
              >
                ...
                <div className="form-group">
                  ...
                  >
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={isManualBrand}
                        onChange={(e) => {
                          setIsManualBrand(e.target.checked);
                          setForm({ ...form, tohum_markasi: "" });
                        }}
                      />
                      Elle Yaz
                    </label>
                  ...
                  {isManualBrand ? (
                    <input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, tohum_markasi: e.target.value })
                      }
                    />
                  ) : (
                      ...
                      >
                        ...
                        >
                          {form.tohum_markasi ? (
                            <>
                              {(() => {
                                const matched = PREDEFINED_BRANDS.find(
                                  (b) => b.name === form.tohum_markasi,
                                );
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, tohum_cesidi: e.target.value })
                    }
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, tohum_notu: e.target.value })
                    }
                  />
                </div>
              </div>
